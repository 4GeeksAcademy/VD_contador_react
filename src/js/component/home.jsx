...
// cuando paso las props, los debo colocar entre llaves!
const Home = ({contador_1,contador_2,contador_3,contador_4,contador_5,contador_6}) => {
	return (
		// genero el contenedor principal para almacenar cada uno de los componentes "Counter"
		<div className="container-fluid d-flex justify-content-between gap-3 bg-black p-3">
				{/* inserto cada uno de los componentes que van a contener los contadores */}
